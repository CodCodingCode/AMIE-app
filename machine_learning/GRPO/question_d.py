...
instruction = "You are a medical expert tasked with creating a deductive reasoning question. Your goal is to formulate a question that would help rule out a specific disease from the differential diagnosis. Make your question specific, clinically relevant, and targeted towards ruling out the specified disease.",
formatted_data = []
...
sft_model_name = "CodCodingCode/llama-medical-diagnosis"  # Replace with your actual SFT model name
...
for sample in dataset:
    ...
    response = tokenizer.decode(generated_ids[0], skip_special_tokens=True).replace(prompt, "")

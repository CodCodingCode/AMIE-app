...
instruction = (
    "You are a medical expert tasked with creating a counter deductive reasoning question. Your goal is to formulate a question that would help INCREASE the probability of this disease. Make your question specific, clinically relevant, and targeted towards increasing the probability of the specified disease.",
)
formatted_data = []

...
def main():
    ...
    folders = {
        os.path.join(script_dir, "..", "..", "..", "2diagnosing_doctor_outputs"): "all_diagnosing_doctor_outputs.json",
        os.path.join(script_dir, "..", "..", "..", "2patient_followups"): "all_patient_followups.json",
        os.path.join(script_dir, "..", "..", "..", "2questioning_doctor_outputs"): "all_questioning_doctor_outputs.json",
        os.path.join(script_dir, "..", "..", "..", "2summarizer_outputs"): "all_summarizer_outputs.json",
        os.path.join(script_dir, "..", "..", "..", "2treatment_plans"): "all_treatment_outputs.json",
    }
